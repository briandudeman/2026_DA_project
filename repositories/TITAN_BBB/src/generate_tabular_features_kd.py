...
def main(task):
    df = pd.read_csv(f'/Users/lewconb/2026 Project/TITAN-BBB/archive/kiba_all.csv')
    ...
    np.save(f'/Users/lewconb/2026 Project/TITAN-BBB/features/kd_kiba_predict-tabular-{task}.npy', combined)
