...
def main(task):
  ...
  process_data(linkdti_data_predict,  encoder, device, "linkdti_data_predict", task)
...
def process_data(df, encoder, device, set_name, task, batch_size=32):
  ...
  np.save(f'/Users/lewconb/2026 Project/LinkDTI_BBB/linkdti_bbb_data/{set_name}-image-{task}.npy', out)
